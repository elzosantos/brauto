    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex px-3 py-4">
                    <x-dropdown>
                        <x-slot name="trigger">
                            <button
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex px-3 py-4">
                    <x-dropdown>
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('consultancies.index')">
                                {{ __('Consultorias') }}
                            </x-dropdown-link>
